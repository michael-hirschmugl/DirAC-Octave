function [LSsig, DIRsig, DIFFsig, DirAC_struct] = DirAC_run_stft( ...
                                                  insig, DirAC_struct)
...
% normally 4 for B-format
nInChan = size(insig,2);
...
for idx = 0:hopsize:(Nhop-2)*hopsize
    ...
    [pars,DirAC_struct] = computeDirectionalParameters(inFramespec(1:2:end,:), ...
                                                       DirAC_struct);   
    ...
    diffOutsig(idx+(1:fftsize),:) = diffOutsig(idx + (1:fftsize),:) ...
                                                   + diffOutFramesig;
end
